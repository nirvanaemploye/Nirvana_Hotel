    ...
    <section>
      <div data-aos="fade" style={BgStyle} className="">
        <div className="bg-gradient-to-r from-black/80 to-transparent  ">
          ...
          <div className="space-y-8 text-white md:w-1/2 text-center md:text-left  ">
            <h1 data-aos="fade-right" className="text-5xl font-extrabold 2xl:leading-normal">Find Your Perfect Stay Book Now & Save Big.</h1>
            <p data-aos="fade-right" className="font-normal text-sm w-96 leading-8 mx-auto md:mx-0">
              Lorem Ipsum is simply dummy text of the printing and typesetting
              industry. Lorem Ipsum has been the industry's standard dummy text
              ever since the 1500s
            </p>
            <PrimaryBtn delay={500} className="hover:bg-secondary transition duration-300 py-2 w-24 sm:w-28" >Sing Up</PrimaryBtn>
          </div>
          </div>
        </div>
      </div>
